...
const N=["Pyne","OSU","Chapel","Bldg 21","Admissions","Dining Hall","Library","Centennial","Bricks 3 & 4","VISTA","Bricks 1 & 2","Health Center"]; // Building names (student names)
const L=[[-15,5],[-20,-15],[-4,16],[20,5],[15,-7],[0,-15],[23,0],[-14,-8],[0,12],[-8,-32],[10,8],[25,-10]]; // Label offsets: [x,y] adjusted to avoid overlaps
